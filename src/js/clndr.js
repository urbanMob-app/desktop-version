...
(function (factory) {
  ...
  var clndrTemplate =
    "<div class='clndr-controls' style='display: flex;justify-content: space-between;'>" +
        "<div class='clndr-control-button'>" +
            "<div class='clndr-previous-button clndr-seta-button'>‹</div>" +
        '</div>' +
        "<div class='month'><%= month %> <%= year %></div>" +
        "<div class='clndr-control-button rightalign'>" +
            "<div class='clndr-next-button clndr-seta-button'>›</div>" +
        '</div>' +
    '</div>' +
